...
impl TreeCtx<'_> {
    ...
    fn build_tree(
        ...
        PostResponse {
            ...
            author_public_key_hex: crate::users::hex_lower(&meta.author_public_key),
            body,
    ...
    Ok(rows
        ...
        .map(|row| {
            ...
            PostMeta {
                ...
                author_public_key: row.public_key,
...
pub async fn get_thread(
    ...
    let op = PostResponse {
        ...
        author_public_key_hex: crate::users::hex_lower(&op_meta.author_public_key),
        body: op_body_str,
    ...
    Ok(Json(ThreadDetailResponse {
        ...
        author_public_key_hex: crate::users::hex_lower(&thread_info.author_public_key),
